...
import random
os.environ['MEMORY_FS_ROOT'] = "/mnt/data" 
os.environ['JOBLIB_TEMP_FOLDER']  = "/mnt/data"
import pdb
...
def main():
    ...
    logger = TensorBoardLogger('tb_logs', name=config.log_name,default_hp_metric=False)
    ...
    trainer = pl.Trainer(devices=config.gpus, max_epochs=config.max_epoch, accelerator='auto',
                         check_val_every_n_epoch=config.check_val_every_n_epoch,log_every_n_steps=20,
